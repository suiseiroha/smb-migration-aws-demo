...
if __name__ == "__main__":
    ...
    # under an ALB means a health check arriving mid-request (while a slow
    # RDS/DynamoDB call is in flight) can time out and get this instance
    # marked unhealthy -- discovered via real ASG churn during milestone 6.
