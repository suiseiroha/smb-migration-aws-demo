...
CloudWatch, SSM, Secrets Manager (scoped to `smb-migration-demo/*`
secret names, for the manual build's app secrets, see Part 5 of either
simulation guide), and CloudFormation (for `cdk deploy`).
...
your own machine. Access keys are credentials, and they shouldn't be
